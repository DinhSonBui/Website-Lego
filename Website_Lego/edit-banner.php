  ...
  <body>
    <?php
      ...
      if(isset($_POST['edit-banner'])){
          $new_title_banner = $_POST['title_banner'];
          $new_name_banner = $_POST['name_banner'];
          $new_description_banner = $_POST['description_banner'];
          $new_img_banner = $_POST['img_banner'];
          $sql = "UPDATE tbl_banner SET title_banner='$new_title_banner', name_banner='$new_name_banner', description_banner='$new_description_banner',img_banner = '$new_img_banner' Where id =$id";
    ...
    <h1 class="heading">Sửa <span>banner</span></h1>
